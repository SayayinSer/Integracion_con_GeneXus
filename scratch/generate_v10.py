...
GUIDS = {
    ...
    "API_Zona_Broken": "f1e2d3c4-b5a6-9788-7654-3210fedcba98" # Potential GUID for the broken one
}
...
{{
    [Description("Dummy fixed version of broken singular API.")]
    [RestMethod(GET)]
    Listar(in:&Nombre, out:&Messages)
    => Zona_Insertar(in:&Nombre, out:&Messages);
}}]]></Source>
      </Part>
      <Part type="c44bd5ff-f918-415b-98e6-aca44fed84fa">
        <Source><![CDATA[// Empty Events to clear errors]]></Source>
      </Part>
    </Object>
  </Objects>
</ExportFile>
