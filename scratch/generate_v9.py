...
<ExportFile>
  ...
  <Objects>
    <!-- Zona_SDT -->
    <Object name="Zona_SDT" type="447527b5-9210-4523-898b-5dccb17be60a" guid="{GUIDS['Zona_SDT']}">
      <Part type="5c2aa9da-8fc4-4b6b-ae02-8db4fa48976a">
        <Level Name="Zona_SDT">
          <LevelInfo guid="{GUIDS['Zona_SDT_Level']}" name="Zona_SDT" type="a76e9340-bdb9-445d-8f81-cfd4ddd0b0f3" description="Zona SDT" />
          <Item name="ZonaId" type="f76e9340-bdb9-445d-8f81-cfd4ddd0b0f3">
            <Properties><Property><Name>idBasedOn</Name><Value>Attribute:ZonaCodigo</Value></Property></Properties>
          </Item>
          <Item name="ZonaNombre" type="f76e9340-bdb9-445d-8f81-cfd4ddd0b0f3">
            <Properties><Property><Name>idBasedOn</Name><Value>Attribute:ZonaNombre</Value></Property></Properties>
          </Item>
          <Item name="ExisteSioNo" type="f76e9340-bdb9-445d-8f81-cfd4ddd0b0f3">
    ...
    <!-- ZonaListaSDT -->
    <Object name="ZonaListaSDT" type="447527b5-9210-4523-898b-5dccb17be60a" guid="{GUIDS['ZonaListaSDT']}">
      <Part type="5c2aa9da-8fc4-4b6b-ae02-8db4fa48976a">
        <Level Name="ZonaListaSDT">
          <LevelInfo guid="{GUIDS['ZonaListaSDT_Level']}" name="ZonaListaSDT" type="a76e9340-bdb9-445d-8f81-cfd4ddd0b0f3">
            <Properties><Property><Name>AttCollection</Name><Value>True</Value></Property></Properties>
          </LevelInfo>
          <Item name="ZonaItem" type="f76e9340-bdb9-445d-8f81-cfd4ddd0b0f3">
    ...
    <!-- Zona_DP -->
    <Object name="Zona_DP" type="2a9e9aba-d2de-4801-ae7f-5e3819222daf" guid="{GUIDS['Zona_DP']}">
...
{{
    ...
    <!-- ZonaLista_DP -->
    <Object name="ZonaLista_DP" type="2a9e9aba-d2de-4801-ae7f-5e3819222daf" guid="{GUIDS['ZonaLista_DP']}">
      <Part type="1d8aeb5a-6e98-45a7-92d2-d8de7384e432">
...
Event Modificar.Before
    if &Buscar_ZonaId <= 0 or &Buscar_ZonaNombre.IsEmpty()
        &RestCode = 412
        return
    endif
Endevent
...
Endevent]]></Source>
      ...
      <Part type="e4c4ade7-53f0-4a56-bdfd-843735b66f47">
        ...
        <Variable Name="ZonaSDT"><Properties><Property><Name>ATTCUSTOMTYPE</Name><Value>sdt:Zona_SDT</Value></Property></Properties></Variable>
        <Variable Name="Messages"><Properties><Property><Name>ATTCUSTOMTYPE</Name><Value>sdt:Messages, GeneXus.Common</Value></Property></Properties></Variable>
        <Variable Name="RestCode"><Properties><Property><Name>ATTCUSTOMTYPE</Name><Value>bas:Numeric</Value></Property><Property><Name>Length</Name><Value>4</Value></Property></Properties></Variable>
      </Part>
