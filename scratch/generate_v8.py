...
&Messages = &Zona.GetMessages()]]></Source>
    ...
    <!-- Zona_Modificar -->
    <Object user="FACTORIAGX\\Sergio" versionDate="0001-01-01T00:00:00.0000000" lastUpdate="2026-05-08T16:54:30.0000000Z" guid="{GUIDS['Zona_Modificar']}" name="Zona_Modificar" type="84a12160-f59b-4ad7-a683-ea4481ac23e9" description="Modificar Zona">
      <Part type="528d1c06-a9c2-420d-bd35-21dca83f12ff">
...
&Messages = &Zona.GetMessages()]]></Source>
    ...
    <!-- Zona_Borrar -->
    <Object user="FACTORIAGX\\Sergio" versionDate="0001-01-01T00:00:00.0000000" lastUpdate="2026-05-08T16:54:30.0000000Z" guid="{GUIDS['Zona_Borrar']}" name="Zona_Borrar" type="84a12160-f59b-4ad7-a683-ea4481ac23e9" description="Borrar Zona">
      <Part type="528d1c06-a9c2-420d-bd35-21dca83f12ff">
        <Source><![CDATA[&Zona.Load(&ZonaId)
if &Zona.Delete()
    commit
