...
.EXAMPLE
.\Test-77LabKbStructure.ps1

.EXAMPLE
.\Test-77LabKbStructure.ps1 -KbRoot "C:\CAMINHO\PARA\PastaParalelaDaKb"
#>
...
$SharedSkillsRoot = "d:\aaProyectos\Entorno04\.agents\skills"
    $catalogPath = Join-Path $SharedSkillsRoot 'scripts-xpz\gx-object-type-catalog.json'
...
foreach ($script in @(
    'Update-77LabKbFromXpz.ps1',
    'Test-77LabKbFullSnapshot.ps1',
    'Query-77LabKbIntelligence.ps1',
    'Rebuild-77LabKbIntelligenceIndex.ps1',
    'Test-77LabKbGate.ps1',
    'Get-77LabKbMetadata.ps1',
