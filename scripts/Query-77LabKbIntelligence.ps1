...
.EXAMPLE
.\Query-77LabKbIntelligence.ps1 -Query impact-basic -ObjectType Procedure -ObjectName procExemplo -Limit 10 -Format text

.EXAMPLE
.\Query-77LabKbIntelligence.ps1 -Query functional-trace-basic -ObjectType Procedure -ObjectName procExemplo -Limit 20 -Format text

.EXAMPLE
.\Query-77LabKbIntelligence.ps1 -Query index-metadata -Format text
#>
...
$enginePath = Join-Path $SharedSkillsRoot "scripts-xpz\Query-KbIntelligenceIndex.ps1"
