...
Dependencias: Query-77LabKbIntelligence.ps1 e Test-77LabKbStructure.ps1 na mesma pasta.

.PARAMETER QueryWrapperPath
Caminho opcional para o wrapper local de consulta do indice.
Quando omitido, usa Query-77LabKbIntelligence.ps1 na mesma pasta deste script.

.PARAMETER StructureWrapperPath
Caminho opcional para o wrapper local de verificacao de estrutura.
Quando omitido, usa Test-77LabKbStructure.ps1 na mesma pasta deste script.

.EXAMPLE
.\Test-77LabKbGate.ps1
...
if (-not $QueryWrapperPath) {
    $QueryWrapperPath = Join-Path $PSScriptRoot 'Query-77LabKbIntelligence.ps1'
}

if (-not $StructureWrapperPath) {
    $StructureWrapperPath = Join-Path $PSScriptRoot 'Test-77LabKbStructure.ps1'
}
