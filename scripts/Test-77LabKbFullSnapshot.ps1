...
.EXAMPLE
.\Test-77LabKbFullSnapshot.ps1 -InputPath C:\Exports\FullKb.xpz -ExpectedItems 'Transaction:Cliente'

.EXAMPLE
.\Test-77LabKbFullSnapshot.ps1 -InputPath C:\Exports\FullKb.xpz -ExpectedItems 'Transaction:Cliente', 'Procedure:GeraBoleto'
#>
...
$wrapperPath = Join-Path $scriptRoot "Update-77LabKbFromXpz.ps1"
