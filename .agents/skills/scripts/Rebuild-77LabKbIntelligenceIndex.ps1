...
.EXAMPLE
.\Rebuild-77LabKbIntelligenceIndex.ps1 -FailOnValidationFailure

.EXAMPLE
.\Rebuild-77LabKbIntelligenceIndex.ps1 -ValidationCasesPath "C:\CAMINHO\PARA\casos-validacao.json" -FailOnValidationFailure
#>
...
$enginePath = Join-Path $SharedSkillsRoot "scripts-xpz\Build-KbIntelligenceIndex.ps1"
